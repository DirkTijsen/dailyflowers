...
const resources = {
  ...
  cashflow_afs_blocks: {
    table: "public.cashflow_afs_blocks",
    columns: [
      "id",
      "block_number",
      "reference_machine_count",
      "afs_amount",
      "roofs_140_amount",
      "shipping_amount",
      "quality_check_amount",
      "installation_amount",
      "kpn_mollie_amount",
      "location_renovation_amount",
      "created_at",
      "updated_at",
    ],
    writable: true,
  ...
  wefact_invoice_lines: {
    table: "public.wefact_invoice_lines",
    columns: [
      "id",
      "invoice_id",
      "invoice_number",
  ...
  vw_wefact_invoices_monthly: {
    table: "public.vw_wefact_invoices_monthly",
    columns: [
      "period",
      "invoice_count",
      "paid_count",
...
async function loadAfsRentalInvoiceContext(invoiceId) {
  ...
  return {
    invoice: {
      ...
      energy_cost_net: moneyNumber(row.energy_cost_net),
...
function buildAfsInvoicePdf(context) {
  ...
  const lines = [
    ...
    { text: "Energiekosten", size: 10, x: 64, y: 487 },
    { text: formatMoney(invoice.energy_cost_net), size: 10, x: 455, y: 487 },
    { type: "line", x1: 50, y1: 470, x2: 545, y2: 470, color: [230, 230, 230] },
    {
    ...
    { text: formatMoney(invoice.variable_fee_net), size: 10, x: 455, y: 460 },
    {
...
function buildAfsInvoiceUbl(context) {
  ...
  const lines = [
    ...
    },
    {
      ...
      name: "Energiekosten",
      description: `${machine.display_name} - ${periodLabel(invoice.period)}`,
      amount: invoice.energy_cost_net,
    },
    {
      id: "3",
